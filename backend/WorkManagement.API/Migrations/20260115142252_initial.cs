        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoreType = table.Column<int>(type: "int", nullable: true),
                    ProjectId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileTickets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FileTickets_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FileTickets_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FileTickets_Users_CurrentHolderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsInBacklog = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WorkItems_WorkflowStatuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                name: "FileTicketTransfers",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FileTicketId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileTicketTransfers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FileTicketTransfers_FileTickets_FileTicketId",
                        column: x => x.FileTicketId,
                        principalTable: "FileTickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FileTicketTransfers_Users_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FileTicketTransfers_Users_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileTicketId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActivityLogs_FileTickets_FileTicketId",
                        column: x => x.FileTicketId,
                        principalTable: "FileTickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_FileTicketId",
                table: "ActivityLogs",
                column: "FileTicketId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileTickets_CreatedById",
                table: "FileTickets",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_FileTickets_CurrentHolderId",
                table: "FileTickets",
                column: "CurrentHolderId");

            migrationBuilder.CreateIndex(
                name: "IX_FileTickets_ProjectId",
                table: "FileTickets",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_FileTickets_TicketNumber",
                table: "FileTickets",
                column: "TicketNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FileTicketTransfers_FileTicketId",
                table: "FileTicketTransfers",
                column: "FileTicketId");

            migrationBuilder.CreateIndex(
                name: "IX_FileTicketTransfers_FromUserId",
                table: "FileTicketTransfers",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_FileTicketTransfers_ToUserId",
                table: "FileTicketTransfers",
                column: "ToUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkItems_ProjectId_ItemNumber",
                table: "WorkItems",
                columns: new[] { "ProjectId", "ItemNumber" },
                unique: true);
